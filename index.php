 ...
 <header>
    ...
    <div class="inicio-color">
        ...
        <div class="imagen-inicio">
            <img src="https://static.wixstatic.com/media/0784b1_636e025454fa4d40a2374266c91e07b8~mv2.jpg/v1/fill/w_728,h_455,al_c,q_80,enc_avif,quality_auto/cans-reduced.jpg" alt="Imagen de bienvenida"> 
        </div>
    </div>
  ...
  <section class="seccion-elegirnos aparecer">
    ...
    <div class="elegirnos-contenido">
        ...
        <div class="elegirnos-imagen">
            <img src="https://graffica.info/wp-content/uploads/2017/10/03-970x599.jpg" alt="Plantillas web">
        </div>
    ...
    <div class="carrusel-contenedor">
        ...
        <button class="carrusel-btn" id="btnCarruselIzq"> ‹ </button>

        <div class="carrusel-ventana" id="carruselPlantillas">

            <div class="slide-plantilla">
                <img src="imgs/eso.png" alt="Plantilla web">
            </div>

            <div class="slide-plantilla">
                <img src="imgs/tour.jpg" alt="Plantilla web">
            </div>

            <div class="slide-plantilla">
                <img src="imgs/desig.png" alt="Plantilla web">
            </div>

            <div class="slide-plantilla">
                <img src="https://images01.nicepagecdn.com/page/31/62/es/plantilla-html-31627.jpg" alt="Plantilla web">
            </div>

        </div>

        <button class="carrusel-btn" id="btnCarruselDer"> › </button>
    ...
    <div class="informacion3 aparecer">
        ...
        <div class="izquierda3">
            ...
            <div class="pri-izquierda3">
                <img src="https://static.wixstatic.com/media/110ec7_29c3c950c65d44c9a3106b9bba6a0d98~mv2.png/v1/fill/w_924,h_2019,al_c,q_90,enc_avif,quality_auto/110ec7_29c3c950c65d44c9a3106b9bba6a0d98~mv2.png" alt="Plantilla ejemplo">
            </div>
            
            <div class="seg-izquierda3"> 
                <img src="https://static.wixstatic.com/media/110ec7_10be33f8cf9c40feb0a0f89a993f5dac~mv2.png/v1/fill/w_924,h_2411,al_c,q_95,enc_avif,quality_auto/110ec7_10be33f8cf9c40feb0a0f89a993f5dac~mv2.png" alt="Plantilla ejemplo">
            </div>

            <div class="ter-izquierda3">
                <img src="https://static.wixstatic.com/media/110ec7_44bfb3739bd24c2bab5fbf852fc54800~mv2.png/v1/fill/w_924,h_2288,al_c,q_95,enc_avif,quality_auto/110ec7_44bfb3739bd24c2bab5fbf852fc54800~mv2.png" alt="Plantilla ejemplo">
            </div>
    ...
    <div class="generador-contenido aparecer">
        ...
        <div class="imagen-generador">
            <img src="imgs/generador.png" alt="Generador personalizado">
        </div>
...
<script>
    ...
    const btnCarruselIzq = document.getElementById("btnCarruselIzq");
    const btnCarruselDer = document.getElementById("btnCarruselDer");

    btnCarruselDer.addEventListener("click", function(){
        carruselPlantillas.scrollBy({
            left: 400,
            behavior: "smooth"
        });
    });

    btnCarruselIzq.addEventListener("click", function(){
        carruselPlantillas.scrollBy({
            left: -400,
            behavior: "smooth"
        });
