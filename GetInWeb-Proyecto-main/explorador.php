...
$sql = "SELECT plantillas.*, usuarios.nombre AS nombre_usuario FROM plantillas INNER JOIN usuarios ON plantillas.id_usuario = usuarios.id WHERE 1";
$parametros = []; 
$tipos = "";
                ...
                <?php if ($plantillas->num_rows > 0) { ?>
                    <?php while ($plantilla = $plantillas->fetch_assoc()) { ?>
                        <div class="plantilla-card">
                            <img src="<?php echo htmlspecialchars($plantilla["imagen_preview"]); ?>" alt="Plantilla">
                            <div class="plantilla-info">
                                ...
                                <a href="plantilla.php?id=<?php echo $plantilla["id"]; ?>" class="btn-ver-archivos">Ver archivos</a>
                                <a href="Personalizador/index.html" class="btn-usar">Usar plantilla</a>
                            </div>
                        </div>
                    <?php } ?>
                <?php } else { ?>
                    <p class="sin-resultados">No se encontraron plantillas.</p>
                <?php } ?>
            </div>
        </section>
        ...
        <section class="subir-plantilla-seccion" id="subir">
            <div class="subir-contenedor">
                <div class="subir-texto">
                    ...
                    <p>Cargá los archivos de tu plantilla, como HTML, CSS, JavaScript o PHP. La plantilla quedará guardada en la base de datos y en la carpeta de archivos.</p>
                </div>
                <form action="subir_plantilla.php" method="POST" enctype="multipart/form-data" class="form-plantilla">
                    ...
                    <div class="campo-form campo-completo">
                        ...
                        <input type="file" name="archivos[]" multiple accept=".html,.css,.js,.php,.txt" required>
                        <small>Podés subir archivos HTML, CSS, JS, PHP o TXT.</small>
                    </div>
